...
object MPRApp {
   def main(args: Array[String]) {   
      ...
      val arquivo = sc.textFile("file:///home/carlos/HadoopDataAnalysis/spark-igti/arquivoBigData.txt")    
      ...
      grupo_ord.saveAsTextFile("file:///home/carlos/HadoopDataAnalysis/spark-igti/resultado.txt");
